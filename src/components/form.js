...
const FormComponent = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await fetch('https://script.google.com/macros/s/AKfycby9FnlMEfzRnbKkC5ovsdnAu4BejG4laxoIg95-JeOUvYB3g8nAcRvqgG_uLRz0jqDVSQ/exec', {
        method: 'POST',
        headers: {
...
return (
  <form onSubmit={handleSubmit} className="form-container">
    ...
    {/* Ensure that `name` attribute matches the headers in Google Sheets */}
